...
- [x] Task 5: Real-time Status Tracking (AC: 4)
...
- `/packages/shared/src/types/processing.ts` - Modified: Updated ProcessingJob interface to match API response, added COMPLETED_WITH_ERRORS status
